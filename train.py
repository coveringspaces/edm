...
@click.option('--precond',       help='Preconditioning & loss function', metavar='vp|ve|cfm|edm',   type=click.Choice(['vp', 've', 'cfm', 'edm']), default='edm', show_default=True)
...
def main(**kwargs):
    ...
    elif opts.precond == 'cfm':
        c.network_kwargs.class_name = 'training.networks.CFMPrecond'
        c.loss_kwargs.class_name = 'training.loss.CFMLoss'
    else:
